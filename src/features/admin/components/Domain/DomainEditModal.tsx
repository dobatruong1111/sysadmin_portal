...
export const ConnectedDomainEditModal = () => {
    ...
    const selectedRow = useSelector((state: any) => state.tableReducer.data[TABLE_DOMAIN].selection.selectedRow);
...
export const DomainEditModal = forwardRef<HTMLElement, DomainEditModalProps>((props, ref) => {
