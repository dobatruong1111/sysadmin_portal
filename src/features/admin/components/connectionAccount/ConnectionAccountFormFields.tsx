...
export const ConnectionAccountFormFields = (props: ConnectionAccountFormFieldsProps) => {
    const { control, errorMessage, disableIdField, types = [], authorities = [], hospitals = [] } = props;
    return (
