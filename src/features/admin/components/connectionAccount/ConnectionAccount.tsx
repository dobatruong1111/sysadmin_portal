...
export const ConnectionAccount = () => {
  ...
  const query = useSelector((state: any) => state.tableReducer.data[TABLE_CONNECTION_ACCOUNT].query);
  const { data, isFetching, refetch } = useGetConnectionAccountListQuery(query || skipToken);
