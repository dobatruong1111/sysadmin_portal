...
import { ConnectionAccountDTO, ConnectionAccountDTOFormUpdate, ConnectionAccountDTOUpdate } from "../../../../types/dto/connectionAccount"
...
export const ConnectionAccountEditForm = (props: ConnectionAccountEditFormProps) => {
    ...
    const onSubmit = async (formData: ConnectionAccountDTOFormUpdate) => {
        ...
        if (submitForm.secret.length === 0 || submitForm.type.length === 0 || submitForm.authorities.length === 0) setErrorMessage('Trường bắt buộc không được bỏ trống');
        else {
