...
export const ConsumableType = () => {
  ...
  const query = useSelector((state: any) => state.tableReducer.data[TABLE_CONSUMABLE_TYPE].query);
  const { data, isFetching, refetch } = useGetConsumableTypeListQuery(query || skipToken);
