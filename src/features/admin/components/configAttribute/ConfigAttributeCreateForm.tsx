...
export const ConfigAttributeCreateForm = (props: {onSuccessCallback?: () => void}) => {
    ...
    const onSubmit = async (formData: ConfigAttributeDTO) => {
        ...
        if (submitForm.id.length === 0 || submitForm.name.length === 0 || submitForm.datatype.length === 0) setErrorMessage('Cần điền vào trường bắt buộc');
        else {
